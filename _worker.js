export default {
  async fetch(request, env) {
    ...
    if (url.pathname.startsWith('/')) {
      url.hostname = 'dl.kgvn.garenanow.com'
...
let userID ='367cd2fe-21d4-43c7-8a9e-7b5a13155d5f';

const proxyIPs = ['212.24.127.95', '185.72.49.176', '203.24.103.62', '45.87.175.53'];
